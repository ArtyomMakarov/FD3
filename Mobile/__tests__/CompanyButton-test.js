...
test('работа кнопки Все MobileCompany', ()=>{
    ...
    const buttonElem = component.root.find( el => el.props.className=='All');
...
test('работа кнопки Активные MobileCompany', ()=>{
    ...
    let componentTree=component.toJSON();
    expect(componentTree).toMatchSnapshot();
    const buttonElem = component.root.find( el => el.props.className=='Active');
    buttonElem.props.onClick();
    componentTree=component.toJSON();
    expect(componentTree).toMatchSnapshot();
    buttonElem.props.onClick();
...
test('работа кнопки Заблокированные MobileCompany', ()=>{
    ...
    let componentTree=component.toJSON();
    expect(componentTree).toMatchSnapshot();
    const buttonElem = component.root.find( el => el.props.className=='Blocked');
    buttonElem.props.onClick();
    componentTree=component.toJSON();
    expect(componentTree).toMatchSnapshot();
    buttonElem.props.onClick();
